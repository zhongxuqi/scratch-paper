...
import com.musketeer.baselibrary.contant.BuildConfig;
 ...
 * </ul>
 * <p>{@link # LogUtil openLog() 打开日志输出（打印输出和文件输出总开关）}</p>
 * <p>{@link # LogUtil closeLog() 关闭日志输出（打印输出和文件输出）}</p>
 * <p>{@link # LogUtil setSyns(boolean) 文件输出开关}</p>
 * <p>
 * 需要注册权限：
 * <table>
 *  <tr>
